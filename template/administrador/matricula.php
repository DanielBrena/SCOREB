...
<html  lang="en">
  ...
  <section  id="container" class="">
                             ...
                             <form class="form-vertical" role="form">
                                <input id="mat-id-1" type="hidden" value="">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-3">
                                          <input type="text" class="form-control" id="mat-matricula-esperada-1" placeholder="Matricula esperada">
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <div class="col-lg-3">
                                          <input type="text" class="form-control" id="mat-matricula-ciclo-1" placeholder="Matricula del ciclo escolar">
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <div class="col-lg-3">
                                          <input type="text" class="form-control" id="mat-bajas-1" placeholder="Aproximación bajas">
                                      </div>
                                  </div>

                                  <!--<div class="form-group">
                                      <div class="col-lg-2">
                                          <input type="text" class="form-control" id="mat-reinscripcion-1" placeholder="Reinscripción esperada">
                                      </div>
                                  </div>-->
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              <thead>
                              <tr>
                                  <th class="hidden-phone"><i class="icon-book"></i> Programa </th>
                                  <th><i class="icon-info"></i> Matricula esperada</th>
                                  <th><i class="icon-info"></i> Matricula del ciclo escolar</th>
                                  <th><i class="icon-info"></i> Aproximación de bajas</th>
                                  <th><i class="icon-info"></i> Reinscripción esperada</th>
    ...
    <!--this page-->
    <script type="text/javascript" src="js/app-matricula.js"></script>
