...
<html  lang="en">
  ...
  <section  id="container" class="">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                             <form class="form-horizontal" role="form">
                                <input id="tip-id-1" type="hidden" value="">
                                  <div class="form-group">
                                      <label  class="col-lg-2 col-sm-2 control-label">Nombre</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" id="tip-nombre-1" placeholder="Nombre">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="col-md-10">
                                              <textarea id="tip-descripcion-1" class="wysihtml5 form-control" rows="10"></textarea>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                          <button id="tip-enviar-1" type="button" class="btn btn-danger">Enviar</button>
                                          <button id="tip-actualizar-1" type="button" style="display:none;" class="btn btn-primary">Actualizar</button>
                                          <button id="tip-cancelar-1" type="button" style="display:none;" class="btn btn-default">Cancelar</button>
                                      </div>
                                  </div>
                              </form>
                          </div>
    ...
    <!--this page-->
    <script type="text/javascript" src="js/app-tiposbecas.js"></script>
