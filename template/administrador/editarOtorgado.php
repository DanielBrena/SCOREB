...
<html  lang="en">
  <head>
    ...
    <title>Cambiar porcentaje Otorgado</title>
  ...
  <section  id="container" class="">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Cambiar porcentaje del alumno
                          </header>
                          <div id="modal-show"></div>
                          <div class="panel-body">
                             <form class="form-horizontal" role="form">
                                <input id="bec-id-1" type="hidden" value="<?php echo $bec; ?>">

                                 <div class="form-group">
                                  <label  class="col-lg-2 col-sm-2 control-label">Porcentaje solicitado</label>
                                      <div class="col-lg-6">

                                          <input type="text" disabled ="disabled" value="<?php echo $beca->getBec_porcentajeSolicitado(); ?>" class="form-control" id="bec-solicitado-1" placeholder="Porcentaje solicidato">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    <label  class="col-lg-2 col-sm-2 control-label">Porcentaje acordado</label>
                                      <div class="col-lg-6">
                                          <input type="text" value="<?php echo $beca->getBec_porcentajeAcordado(); ?>" class="form-control" id="bec-acordado-1" placeholder="Porcentaje acordado">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-3 col-lg-10">
                                          <button id="bec-enviar-1" type="button" class="btn btn-danger">Actualizar</button>
    ...
    <!--this page-->
    <script type="text/javascript" src="js/app-editarOtorgado.js"></script>
