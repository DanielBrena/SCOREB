...
<html lang="en">
  ...
  <section id="container" class="">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form">
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" id="dan-nombre-programa" placeholder="Nombre">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="col-md-9">
                                              <textarea id="dan-descripcion-programa" class="wysihtml5 form-control" rows="10"></textarea>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                          <button id="enviar-programa" type="button" class="btn btn-danger">Enviar</button>
                                      </div>
                                  </div>
                              </form>
                          </div>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <button id="eliminar-programa-m" class="btn btn-warning" type="button">Eliminar</button>
                                          </div>
                                      </div>
                                  </div>
                          </div>
                          ...
                          <div class="modal fade" id="myModalEditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div id="modal-editar-programa" class="modal-body">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <button data-dismiss="modal" class="btn btn-default" type="button">Cancelar</button>
                                            <button id="enviar-programa-m" class="btn btn-danger" type="button"> Aceptar</button>
    ...
    <script src="js/daniel/formulario_programas.js"></script>
