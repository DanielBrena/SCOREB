...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header white-bg">
          ...
          <!--logo start-->
          <a href="index.html" class="logo" >Beis<span>bol</span></a>
          <!--logo end-->
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li id="administradores"><a  href="javascript:;">Administradores</a></li>
                      </ul>
                  </li>
      ...
      <footer class="site-footer">
          <div class="text-center">
            ...
            <a href="../about/index.php"><h2>Desarrollado por Daniel Brena Aquino y Tamara Pérez Vázquez</h2></a>
              <a href="#" class="go-top">
