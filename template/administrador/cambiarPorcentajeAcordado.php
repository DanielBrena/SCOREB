...
<html  lang="en">
  <head>
    ...
    <title>Alumnos con porcentaje acordado</title>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                        <header class="panel-heading">
                            Alumnos con porcentaje acordado
                        </header>
                           ...
                           <div class="adv-table">
                                ...
                                for ($i=0; $i < count($row); $i++) { 
                                 ...
                                 echo '<td class="hidden-phone">'.$row[$i]['bec_porcentajeSolicitado'].'</td>';
                                  echo '<td class="hidden-phone">'.$row[$i]['bec_porcentajeAcordado'].'</td>';
                                  echo '<td class="center hidden-phone">';
                                  
                                  
                                  echo '<a href="editarOtorgado?alumno='.$row[$i]['bec_id'].'"><button data-id="" class="btn btn-success btn-xs confirm-edit"><i  class="icon-edit"></i></button>';
                                  echo '</td>';
